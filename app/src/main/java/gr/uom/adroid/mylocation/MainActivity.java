...
public class MainActivity extends AppCompatActivity {
    ...
    public void loginBTN(View v){
        String amail = mailTXT.getText().toString();
        String apassword = passwordTXT.getText().toString();
        anAuth.signInWithEmailAndPassword(amail,apassword).addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(!task.isSuccessful()) {
                    ...
                    Toast.makeText(MainActivity.this, "Succsfuly sign in", Toast.LENGTH_SHORT).show();
